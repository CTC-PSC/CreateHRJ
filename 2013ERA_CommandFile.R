...
## READ IN .HRJ DATA ##
#######################
#2013 ERA - 2011/2012 ISBM 
#Set user directory
 userDir=userDir=choose.dir()
#Read in HRJ files in a directory
 by=readHRJdir(userDir, nFisheries=32, straysinescap=FALSE, Age6="ignore")
...
#Write 
 write.csv(z.cy$HRJ_BY, "2011 hrj, cy layout, by method.csv")
 write.csv(z.cy$HRJ_CY, "2011 hrj, cy layout, cy method.csv")
